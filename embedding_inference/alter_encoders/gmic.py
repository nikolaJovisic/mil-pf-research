...
import data_augmentation_utils, gmic_utils
...
class GMIC(nn.Module):
    ...
    def forward(self, x_original, eval_mode=True):
        """
        ...
        if self.experiment_parameters['learningtype'] == 'SIL':
            return self.y_local, self.y_global, self.y_fusion, self.saliency_map, self.patch_locations, self.patches, self.patch_attns, h_crops, concat_vec
        elif self.experiment_parameters['learningtype'] == 'MIL':
